...
object FMPrinterOrder {
    ...
    fun orderForGetFmSelfcheckingPage(): ByteArray {
        var mSendMsg = MPMessage.MPSendMsg.newBuilder().setEventType(MPMessage.EventType.SELFTEST).build()
    ...
    fun orderForGetFmCancelPrinter(): ByteArray {
        ...
        var mSendMsg =
            MPMessage.MPSendMsg.newBuilder().setEventType(MPMessage.EventType.CANCELPRINTING).build()
